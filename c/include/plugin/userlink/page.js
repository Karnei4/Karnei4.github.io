$(document).ready(function(){
 ...
 $(document).on('change', '#file_xmlicon', function(){
  ...
  {
   alert("Invalid Image File! Only .png, .jpg, .jpeg"/*tpa=http://fork.ottv.tk/include/plugin/userlink/Invalid Image File! Only .png, .jpg, .jpeg*/);
  }
 ...
 $(document).on('change', '#file_xml', function(){
  ...
  {
   alert("http://fork.ottv.tk/include/plugin/userlink/Invalid File! Only .xml, .fxml, .m3u, .m3u8");
  }
  var oFReader = new FileReader();

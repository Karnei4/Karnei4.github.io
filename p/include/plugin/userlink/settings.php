...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$echo.="<input type='hidden' name='showonmenu' value='0' /> <input type='checkbox' name='showonmenu'".($PLUGIN["settings"]["showonmenu"]?" checked":"")." value='1' /> Отобразить ссылку $PLUGIN[name] в Меню / Категории<br>";
